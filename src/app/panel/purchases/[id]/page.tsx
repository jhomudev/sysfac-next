...
import TableOperationsPerPurchase from '@/modules/Transactions/components/TableOperationsPerPurchase'
import { getOperationsByTransactionId, getPurchaseById } from '@/modules/Transactions/services'
